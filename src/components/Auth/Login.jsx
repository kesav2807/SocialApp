  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#6A1B9A] px-4 text-white font-sans">
      <div className="flex flex-col md:flex-row bg-white text-gray-800 shadow-2xl rounded-3xl overflow-hidden max-w-6xl w-full">
        ...
        >
          <h3 className="text-2xl font-bold text-center mb-2 text-[#6A1B9A]">USER LOGIN</h3>
          <p className="text-sm text-center text-gray-500 mb-6">Welcome back! Please login to your account.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex justify-between items-center text-sm text-gray-500">
              ...
              {/* <Link to="/forgot-password" className="hover:underline text-purple-700">
                Forgot Password?
              </Link> */}
            </div>
